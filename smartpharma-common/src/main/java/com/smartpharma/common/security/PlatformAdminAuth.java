package com.smartpharma.common.security;
 ...
 * must NOT be reachable by any pharmacy's regular ADMIN role, no matter how well
 ...
 * tied to any pharmacy/user account at all. Checked explicitly in the controller
