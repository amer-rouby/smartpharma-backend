package com.smartpharma.expenses.service.impl;
...
import com.smartpharma.expenses.entity.Expense;
...
public class ExpenseServiceImpl implements ExpenseService {
    ...
    public ExpenseResponse createExpense(ExpenseRequest request, Long userId) {
        ...
        try {
            eventPublisher.publishEvent(new ExpenseAddedEvent(pharmacy.getId(), saved.getId(), saved.getAmount()));
        } catch (Exception e) {
