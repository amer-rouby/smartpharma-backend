package com.smartpharma.payments.repository;

import com.smartpharma.payments.entity.Payment;
import com.smartpharma.payments.entity.enums.PaymentStatus;
...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    Optional<Payment> findByReferenceNumberAndPharmacyId(String referenceNumber, Long pharmacyId);
