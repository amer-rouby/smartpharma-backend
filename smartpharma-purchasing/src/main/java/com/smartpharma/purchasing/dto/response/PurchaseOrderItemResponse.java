package com.smartpharma.purchasing.dto.response;
...
public class PurchaseOrderItemResponse {
    ...
    public static PurchaseOrderItemResponse fromEntity(com.smartpharma.purchasing.entity.PurchaseOrderItem item) {
