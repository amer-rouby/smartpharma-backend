...
public class ProfileServiceImpl implements ProfileService {
    ...
    public ProfileResponse updateProfile(Long userId, ProfileUpdateRequest request) {
        ...
        if (request.getProfileImageUrl() != null &&
                !request.getProfileImageUrl().equals(profile.getProfileImageUrl())) {
            profile.setProfileImageUrl(request.getProfileImageUrl());
            profileChanged = true;
        }
        if (request.getJobTitle() != null &&
                !request.getJobTitle().equals(profile.getJobTitle())) {
            profile.setJobTitle(request.getJobTitle());
            profileChanged = true;
        }
        if (request.getDepartment() != null &&
                !request.getDepartment().equals(profile.getDepartment())) {
            profile.setDepartment(request.getDepartment());
            profileChanged = true;
        }
        if (request.getAddress() != null &&
                !request.getAddress().equals(profile.getAddress())) {
        ...
        if (request.getCountry() != null &&
                !request.getCountry().equals(profile.getCountry())) {
